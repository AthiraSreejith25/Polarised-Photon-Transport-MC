...
#		x = 5.213 #size parameter
		...
		theta = np.linspace(0,180,361) #this is the range of cosine of the scattering angles
	...
	def scatter(self):
		...
		while p_rand > p:
			...
			S1, S2 = S1_S2[0][alpha+180], S1_S2[1][alpha+180]

#			print ((p1+p2,p1,p2,alpha/10))
			print ('         ',photon.stokes)
...
#			print ('--@@@@  ',p)
			p1 = (s11*photon.stokes[0])
			p2 = s12*(photon.stokes[1]*np.cos(2*beta)+photon.stokes[2]*np.sin(2*beta))
