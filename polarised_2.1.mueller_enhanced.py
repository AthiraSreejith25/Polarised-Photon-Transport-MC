...
mueller[0][0] = abs(M[d['o']][d['o']])
mueller[0][1] = abs(M[d['h']][d['o']]-M[d['v']][d['o']])/2
mueller[0][2] = abs(M[d['p']][d['o']]-M[d['m']][d['o']])/2
mueller[0][3] = abs(M[d['l']][d['o']]-M[d['r']][d['o']])/2

mueller[1][0] = abs(M[d['o']][d['h']]-M[d['o']][d['v']])/2
mueller[1][1] = abs(((M[d['h']][d['h']]+M[d['v']][d['v']])/4) - ((M[d['h']][d['v']]+M[d['v']][d['h']])/4))
mueller[1][2] = abs(((M[d['p']][d['h']]+M[d['m']][d['v']])/4) - ((M[d['p']][d['v']]+M[d['m']][d['h']])/4))
mueller[1][3] = abs(((M[d['l']][d['h']]+M[d['r']][d['v']])/4) - ((M[d['l']][d['v']]+M[d['r']][d['h']])/4))

mueller[2][0] = abs(M[d['o']][d['p']]-M[d['o']][d['m']])/2
mueller[2][1] = abs(((M[d['h']][d['p']]+M[d['v']][d['m']])/4) - ((M[d['h']][d['m']]+M[d['v']][d['p']])/4))
mueller[2][2] = abs(((M[d['p']][d['p']]+M[d['m']][d['m']])/4) - ((M[d['p']][d['m']]+M[d['m']][d['p']])/4))
mueller[2][3] = abs(((M[d['l']][d['p']]+M[d['r']][d['m']])/4) - ((M[d['l']][d['m']]+M[d['r']][d['p']])/4))

mueller[3][0] = abs(M[d['o']][d['l']]-M[d['o']][d['r']])/2
mueller[3][1] = abs(((M[d['h']][d['l']]+M[d['v']][d['r']])/4) - ((M[d['h']][d['r']]+M[d['v']][d['l']])/4))
mueller[3][2] = abs(((M[d['p']][d['l']]+M[d['m']][d['r']])/4) - ((M[d['p']][d['r']]+M[d['m']][d['l']])/4))
mueller[3][3] = abs(((M[d['l']][d['l']]+M[d['r']][d['r']])/4) - ((M[d['l']][d['r']]+M[d['r']][d['l']])/4))
